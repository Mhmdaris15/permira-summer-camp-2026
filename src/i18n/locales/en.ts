export const en = {
  ...
  location: {
    ...
    galleryNote: "Kivipark nature reserve · photos: Nikolay Stepanenko & Yu. Vtyurina",
    galleryAlt: "Kubenskiy Island, Kivipark nature reserve",
  ...
  registration: {
    ...
    sectionDocs: "Documents", sectionDocsSub: "We need this on file before we can review your application.",
