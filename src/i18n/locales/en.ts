  ...
  journey: {
    ...
    days: {
      d1: {
        label: "Day One",
        verb: "Arrive & Settle",
        headline: "Meet, cross to the island, and settle in.",
        body: "Participants gather at Ozerki metro in the morning and travel together by bus and boat to Kubenskiy Island. After a safety briefing, teams pitch their tents, break the ice, and warm up with traditional team games — closing the first day with an evening of sharing and storytelling around camp.",
        a1t: "Meet & Transfer", a1d: "Gather at Ozerki metro (09:00 MSK), then bus and boat to the island — please don't be late.",
        a2t: "Tent Setup & Team Bonding", a2d: "Pitch tents by group, then ice-breaking and team-bonding games.",
        a3t: "Fun Games & Storytelling", a3d: "Traditional team games, dinner, and an evening sharing session.",
      },
      d2: {
        label: "Day Two",
        verb: "Cook & Connect",
        headline: "Cook together, play together.",
        body: "The heart of the camp: a Culinary Masterclass & Cooking Session where mixed Indonesian, Russian, and ASEAN teams prepare Indonesian dishes, a cooking challenge with plating and presentation, and a fun night of games capped by a Capture-the-Moment screening and closing circle.",
        a1t: "Culinary Masterclass", a1d: "Hands-on cooking in small mixed teams — Ayam Lalapan, Nasi Goreng Kampung, Sate Taichan.",
        a2t: "Cooking Challenge & Presentation", a2d: "Plate, present, and share your team's dish.",
        a3t: "Fun Night & Closing Circle", a3d: "Games, a photo & video screening, and an optional late campfire.",
      },
      d3: {
        label: "Day Three",
        verb: "Reflect & Farewell",
        headline: "Reflect, celebrate, and head home.",
        body: "Breakfast and a collective camp break-down, a last round of documentation and farewells, and an awarding session recognising teamwork and spirit — closing a weekend of friendship between Indonesian, Russian, and ASEAN students.",
        a1t: "Camp Break-Down", a1d: "Pack up and tidy the site together, leaving no trace.",
        a2t: "Awarding & Appreciation", a2d: "Best cooking, team collaboration, team spirit, and most active participant.",
        a3t: "Closing Session", a3d: "Official close, farewell photos, and journey home.",
      },
    },
  },
