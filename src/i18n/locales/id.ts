...
export const id: Translation = {
  ...
  journey: {
    ...
    days: {
      ...
      d2: {
        label: "Hari Kedua",
        verb: "Masak & Akrab",
        headline: "Inti kemah — PERMIRA Master Chef.",
        body: "Setelah senam pagi dan sarapan Bubur Ayam, PERMIRA Master Chef digelar: sesi edukasi dan diskusi tentang kuliner dua bangsa, masterclass kuliner langsung, dan tantangan fusion yang memadukan Indonesia, Rusia, dan ASEAN. Malam harinya ada permainan di lapangan terbuka, PERMIRA's Got Talent, dan perbincangan dari hati ke hati di api unggun.",
        a1t: "Masterclass Kuliner", a1d: "Memasak langsung dalam tim 5–6 orang bersama chef Aprilio Kristian Justin Teken — Nasi Goreng Kampung, Sate Taichan, dan Sambal Matah.",
        a2t: "Tantangan Kuliner Fusion", a2d: "Setiap tim menciptakan hidangan fusion — Indonesia 50%, Rusia 30%, ASEAN 20% — dinilai oleh dewan juri.",
        a3t: "PERMIRA's Got Talent", a3d: "Malam budaya dwibahasa berisi pertunjukan, lalu lingkaran perbincangan dari hati ke hati di api unggun.",
      },
      d3: {
        label: "Hari Ketiga",
        verb: "Refleksi & Pamit",
  ...
  ceremony: {
    ...
    items: {
      ...
      stulov: "Ketua Komite Lingkungan Hidup Oblast Leningrad",
      ...
      kalyagina: "Wakil Ketua Cabang St. Petersburg dan Oblast Leningrad, Perhimpunan Konservasi Alam Seluruh Rusia",
